# Generated by Django 3.0.8 on 2020-08-24 10:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('completedActivity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='completed_activity', to='ActivitiesApp.ActivityModel')),
                ('triggerActivity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trigger_activity', to='ActivitiesApp.ActivityModel')),
            ],
        ),
        migrations.CreateModel(
