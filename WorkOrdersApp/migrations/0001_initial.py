    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='WorkOrdersApp.TaskActivityModel')),
                ('part', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='PartsApp.PartModel')),
                ('task', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='WorkOrdersApp.TaskModel')),
